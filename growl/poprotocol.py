...
# shouldn't this be onServersList?
...
class POProtocol(Int16StringReceiver, PODecoder):
    ...
    def onAskForPass(self, salt):
        """
        Event callend when server requires password
        salt : Password salt
        """
    ...
    def on_KeepAlive(self, cmd):
        self.onKeepAlive(cmd)

    def onKeepAlive(self, cmd):
        """
        Event called upod recieving KeepAlive
        """
